...
def evaluate(args, generator, retriever, reader, generator_tokenizer, retriever_tokenizer, reader_tokenizer):
...
def main():
    ...
    parser.add_argument("--max_gen_length", default=48, type=int)
