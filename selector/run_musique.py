...
from transformers import (WEIGHTS_NAME, BertConfig,
                                  ...
                                  XLNetTokenizer,
                                  DistilBertConfig, DistilBertForMultipleChoice, DistilBertTokenizer,
                                  AlbertConfig, AlbertForMultipleChoice, AlbertTokenizer,
                                  XLMConfig, XLMForMultipleChoice, XLMTokenizer,
                                  DebertaV2Config, DebertaV2ForMultipleChoice, DebertaV2Tokenizer,
                                  )
...
def load_and_cache_examples(args, tokenizer, evaluate=False, output_examples=False):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache and not output_examples:
        ...
        #     tfds_examples = tfds.load("multi-hop")
