...
def evaluate(
        args, 
        generator, retriever, reader, 
        generator_tokenizer, retriever_tokenizer, reader_tokenizer
    ):
    ...
    for i, data in enumerate(dataset):
        ...
        while clock < 5 and not is_end:
            ...
            output = generator.generate(input_ids=features['input_ids'], 
...
def main():
    ...
    generator_config = generator_config_class.from_pretrained(
    ...
    generator = generator_model_class.from_pretrained(
        args.generator_name_or_path,
        from_tf=bool('.ckpt' in args.generator_name_or_path),
